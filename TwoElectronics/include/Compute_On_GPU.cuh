...
void PairsInitial(particle_pair* Array, const long size);

void PairsFisrtStep(particle_pair* first_array, const long size);

void PairsSecondStepPreQQ(double* QQ);
void PairsSecondStepPreECheck(const double* QQ, const double EE0, double* E_check);


void PairsSecondStepWholeLaserNoStream(particle_pair* first_array, const long size, double* QQ);

void PairsSecondStepWholeLaser(particle_pair* first_array, const long size, double* QQ);
